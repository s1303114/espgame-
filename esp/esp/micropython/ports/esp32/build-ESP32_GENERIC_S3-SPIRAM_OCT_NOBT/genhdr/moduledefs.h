...
extern const struct _mp_obj_module_t lgfx_user_cmodule;
#undef MODULE_DEF_LGFX
#define MODULE_DEF_LGFX { MP_ROM_QSTR(MP_QSTR_lgfx), MP_ROM_PTR(&lgfx_user_cmodule) },
