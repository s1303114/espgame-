...
- `lgfx.update_monk_attack_native(...)` 負責 attack type 1 的 split/drop/sweep + three-orb dive、type 2 的同步 pulse / 三顆錯峰雙峰 pulse update，以及 final one-orb phase；final orb 擊中 Monk 後會直接轉成 hidden/lost，不再在玩家身邊公轉
